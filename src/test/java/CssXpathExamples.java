...
public class CssXpathExamples {
    ...
    void cssXpathExamples() {
        ...
        //<input type="email" class="inputtext login_form_input_box"> type почти никогда не используется, слишком обстрактно
        ...
        // <div> Hello, QA_auto </div>
        $x("//div[text()='Hello, QA_auto']").click();
        $(byText("Hello, QA_auto"));
        $(withText("ello, QA_aut"));
    }
}
